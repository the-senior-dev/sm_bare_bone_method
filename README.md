...
1. Add a favorite movies functionality: users can add a movie to favorites and it will be remembered even if they reload the page

*HINT: Use a state management solution (we recommend `redux` so you practice with it) and persist the state to local storage (`redux-persist`)*
